...
const images = [
  ...
  { src: hft3, alt: "Sharing Experiences", gradient: "from-blue-500 to-purple-500" },
  { src: hft2, alt: "Winners HFT 2023", gradient: "from-yellow-500 to-red-500" },
        ...
        {images.map((image, index) => (
          <div
            ...
            className={`relative transition-all duration-300 ease-in-out ${
              expandedIndex === index ? "w-3/5" : "w-1/5"
            }`}
